public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Issue with the Dequeue function trying to remove item in the second spot (index 1), rather than the first (index 0)
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue was putting items at the front of the list.
    ...
    private void Enqueue(int value) {
        _queue.Add(value); // changed from Insert(0, value) to now use the Add method
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; // changed this to remove from index 0, not 1
        _queue.RemoveAt(0);
        return value;
    }
}